...
export const VAULTS: VaultConfig[] = [
  ...
  },
  {
    ...
    asset: 'FXRP',
    assetAddress: FXRP_ADDRESS,
    address: (process.env.NEXT_PUBLIC_LP_FXRP_USDT0_VAULT || '0x11e86f45374bcdffa35ee56612445df6b1c58c12') as Address,
    accent: '#38BDF8',
    range: '4%',
    status: 'live',
    summary: 'Single-sided FXRP entry into a managed Enosys V3 FXRP/USDT0 concentrated liquidity range.',
  },
  {
    id: 'lp-fxrp-usdt0-25',
