...
// ConcentratedLpVault.sol — the FXRP/USDT0 LP leaf, enterable directly (no carry wrapper).
// redeemInKind is the correct general exit: while the LP position is active a redeem can return
// both assetOut (FXRP) and otherOut (USDT0), unlike a standard ERC-4626 redeem().
export const concentratedLpVaultAbi = [
  {
    type: 'function',
    name: 'deposit',
    stateMutability: 'nonpayable',
...
export const carryVaultAprAbi = [
  ...
  { type: 'function', name: 'idleUsdt0', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 'leafValue', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 'leaf', stateMutability: 'view', inputs: [], outputs: [{ type: 'address' }] },
